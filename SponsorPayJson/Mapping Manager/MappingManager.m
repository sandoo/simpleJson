...
+(RKObjectMapping *)mapForOffers
{
    ...
    RKRelationshipMapping* relationShipMappingTimeToPayout = [RKRelationshipMapping relationshipMappingFromKeyPath:@"time_to_payout"
    ...
    RKRelationshipMapping* relationShipMappingOfferTypes = [RKRelationshipMapping relationshipMappingFromKeyPath:@"offer_types"
